...
for t_equil_i = par.t_equil
    ...
    %% %%%%%% 2023.01.29 %%%%%% %%
    % I guess the following line of code is just for animate the
    % equilibrium state of the SRA, we don't need it for more than 2 arms'
    % situation becasue all the animations and post processing will be put
    % at the very behind, but we can keep it for n_SRA=1.
    % And I think it is also the reason for the presentation of blank
    % figure, even though we don't expect any animation.
