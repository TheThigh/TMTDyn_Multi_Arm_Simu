...
% 2023.01.25
% However, temporarily we haven't found any issues if we do not comment the
% following lines of code.
% if ~isfield( par , 'input' ) || isempty( par.input )
%     par.input=par_temp.input;
% end
% if ~isfield( par , 'output' ) || isempty( par.output)
%     par.output=par_temp.output;
% end
